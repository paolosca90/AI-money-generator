...
export declare function calculateStrategyTargets(strategy: TradingStrategy, currentPrice: number, atr: number, direction: "LONG" | "SHORT", symbol: string, spread: number): StrategyPriceTargets;
export declare function getOptimalStrategy(marketData: any, symbol: string, userPreference?: TradingStrategy): TradingStrategy;

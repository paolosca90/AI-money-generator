...
export async function analyzeWithAI(marketData, symbol) {
    ...
    const enhancedConfidence = calculateEnhancedConfidence(indicators5m, indicators15m, indicators30m, multiTimeframeAnalysis, marketContext, enhancedDirection, symbol);
...
async function simulateSentimentAnalysis() {

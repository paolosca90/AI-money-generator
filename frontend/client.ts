...
export namespace analysis {
    ...
    export class ServiceClient {
        ...
        public async listHistory(): Promise<ResponseType<typeof api_analysis_history_listHistory>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analysis/history`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analysis_history_listHistory>
        }
        ...
        public async listPositions(): Promise<ResponseType<typeof api_analysis_positions_listPositions>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analysis/positions`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analysis_positions_listPositions>
        }
...
export namespace user {
    ...
    export class ServiceClient {
        ...
        public async getMt5Config(): Promise<ResponseType<typeof api_user_api_getMt5Config>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/user/mt5-config`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_api_getMt5Config>
        }
        ...
        public async getPreferences(): Promise<ResponseType<typeof api_user_api_getPreferences>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_api_getPreferences>
        }
        ...
        public async getSubscription(): Promise<ResponseType<typeof api_user_api_getSubscription>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/user/subscription`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_api_getSubscription>
        }
        ...
        public async updateMt5Config(params: RequestType<typeof api_user_api_updateMt5Config>): Promise<ResponseType<typeof api_user_api_updateMt5Config>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/user/mt5-config`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_api_updateMt5Config>
        }
        ...
        public async updatePreferences(params: RequestType<typeof api_user_api_updatePreferences>): Promise<ResponseType<typeof api_user_api_updatePreferences>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/user/preferences`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_api_updatePreferences>
        }
    }
}
